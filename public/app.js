...
async function loadHistoryDetails(historyId) { const data = await api(`/admin/history/${encodeURIComponent(historyId)}`); state.historyDetails = data.details; renderHistoryDetails(); }
