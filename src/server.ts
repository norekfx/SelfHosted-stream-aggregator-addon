...
app.get("/app.js", async (_, reply) => { const [mainScript, addonDeleteHelper, libraryEpisodeIdHelper, animeSubLibraryHelper, libraryAutomationHelper, librarySortHelper, libraryReorderHelper, docchiPublicMappingHelper, docchiDebugExportHelper] = await Promise.all([readFile(join(publicDir, "app.js"), "utf-8"), readFile(join(publicDir, "addon-delete-helper.js"), "utf-8").catch(() => ""), readFile(join(publicDir, "library-episode-id-helper.js"), "utf-8").catch(() => ""), readFile(join(publicDir, "animesub-library-helper.js"), "utf-8").catch(() => ""), readFile(join(publicDir, "library-automation-helper.js"), "utf-8").catch(() => ""), readFile(join(publicDir, "library-sort-helper.js"), "utf-8").catch(() => ""), readFile(join(publicDir, "library-reorder-helper.js"), "utf-8").catch(() => ""), readFile(join(publicDir, "docchi-public-mapping-helper.js"), "utf-8").catch(() => ""), readFile(join(publicDir, "docchi-debug-export-helper.js"), "utf-8").catch(() => "")]); reply.header("cache-control", "no-store, max-age=0"); reply.type("application/javascript; charset=utf-8"); return `${mainScript}\n\n${addonDeleteHelper}\n\n${libraryEpisodeIdHelper}\n\n${animeSubLibraryHelper}\n\n${libraryAutomationHelper}\n\n${librarySortHelper}\n\n${libraryReorderHelper}\n\n${docchiPublicMappingHelper}\n\n${docchiDebugExportHelper}`; });
